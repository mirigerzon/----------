...
# --- 5a. קריאה לתמונה בגווני אפור (נניח שכבר קיבלתם את הקובץ מהשאלה הקודמת) ---
...
def normalize_image(img):
    ...
    # נרמול: מחסרים את המינימום, מכפילים לפי טווח 0-255
...
# --- 6. שינוי פיקסל אחד ל-0 ואחד ל-255 ---
img_extremes = normalized_img.copy()
img_extremes[0, 0] = 0
img_extremes[0, 1] = 255

normalized_extremes = normalize_image(img_extremes)

cv2.imshow("Normalized with Extremes", normalized_extremes)
cv2.waitKey(0)
cv2.destroyAllWindows()